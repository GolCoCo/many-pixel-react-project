...
export const FieldMove = forwardRef(({ value, onChange, showRadio, lastMb, loading }, ref) => {
    ...
    return (
        <Box ref={ref}>
            <ButtonMove loading={loading && value === 'top'} onClick={handleClickTop} isUp selected={value === 'top'} showRadio={showRadio}>
                Move it to the top of my Queue
            </ButtonMove>
            <ButtonMove loading={loading && value === 'bottom'} onClick={handleClickBottom} selected={value === 'bottom'} showRadio={showRadio} $mb={lastMb}>
